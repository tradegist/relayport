...
For the three-location model layout and the rule about model shims, see `services.instructions.md`. For timestamp/fee conventions, see `relays.instructions.md`.
